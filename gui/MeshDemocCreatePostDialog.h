...
#ifndef MESH_DEMOCCREATEPOSTDIALOG_H
#define MESH_DEMOCCREATEPOSTDIALOG_H
...
public:
	 ...
	 * @param meshDemoc
	 */
	explicit MeshDemocCreatePostDialog(TokenQueue* tokenQ, RsMeshDemoc* meshDemoc, const RsGxsGroupId& grpId, QWidget *parent = 0);
...
#endif // MESH_DEMOCCREATEPOSTDIALOG_H
