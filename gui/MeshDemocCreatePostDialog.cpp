...
MeshDemocCreatePostDialog::MeshDemocCreatePostDialog(TokenQueue* tokenQ, RsMeshDemoc *meshDemoc, const RsGxsGroupId& grpId, QWidget *parent):
	QDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint),
	mTokenQueue(tokenQ), mMeshDemoc(meshDemoc), mGrpId(grpId),
	ui(new Ui::MeshDemocCreatePostDialog)
{
	...
	ui->headerFrame->setHeaderImage(QPixmap(":/images/meshDemoc_64.png"));
