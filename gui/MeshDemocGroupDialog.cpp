...
{
	return QPixmap(":/images/meshDemoc_add_64.png");
}
...
bool MeshDemocGroupDialog::service_EditGroup(uint32_t &token, RsGroupMetaData &editedMeta)
{
	RsMeshDemocGroup grp;
	...
	rsMeshDemoc->updateGroup(token, grp);
	return true;
}

bool MeshDemocGroupDialog::service_loadGroup(uint32_t token, Mode /*mode*/, RsGroupMetaData& groupMetaData, QString &description)
{
